...
$links = [
        [
            'key' => 'dashboard',
            'label' => 'Dashboard',
            'href' => is_cluster_admin($user_type) ? 'report-analytics.php' : 'dashboard.php',
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'href' => 'lab-management.php'
                ],
                [
                    'key' => 'asset-management',
                    'label' => 'Asset Management',
                    'href' => 'assets-management.php'
                ],
                [
                    'key' => 'booking-management',
                    'label' => 'Booking Management',
                    'href' => 'booking-management.php'
                ]
            ]
        ],
        [
...
if (is_super_admin($user_type)) {
    array_splice($links, 1, 0, [[
        ...
        'href' => 'report-analytics.php',
        'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.75 18.25V5.75C4.75 5.33579 5.08579 5 5.5 5C5.91421 5 6.25 5.33579 6.25 5.75V18.25C6.25 18.6642 5.91421 19 5.5 19C5.08579 19 4.75 18.6642 4.75 18.25Z" fill="currentColor"/><path d="M10.25 18.25V10.75C10.25 10.3358 10.5858 10 11 10C11.4142 10 11.75 10.3358 11.75 10.75V18.25C11.75 18.6642 11.4142 19 11 19C10.5858 19 10.25 18.6642 10.25 18.25Z" fill="currentColor"/><path d="M15.75 18.25V13.75C15.75 13.3358 16.0858 13 16.5 13C16.9142 13 17.25 13.3358 17.25 13.75V18.25C17.25 18.6642 16.9142 19 16.5 19C16.0858 19 15.75 18.6642 15.75 18.25Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M4 3.75C4 3.33579 4.33579 3 4.75 3H19.25C19.6642 3 20 3.33579 20 3.75C20 4.16421 19.6642 4.5 19.25 4.5H4.75C4.33579 4.5 4 4.16421 4 3.75Z" fill="currentColor"/></svg>'
    ]]);
}
